...
class Cubist(RegressorMixin, BaseEstimator):  # pylint: disable=R0902
    ...
    feature_importances\\_ : pd.DataFrame
    ...
    feature_names_in\\_ : ndarray of shape (`n_features_in_`,)
        Names of features seen during :term:`fit`. Defined only when `X`
        has feature names that are all strings.

    splits\\_ : pd.DataFrame
        Table of the splits built by the Cubist model for each rule.

    coeff\\_ : pd.DataFrame
